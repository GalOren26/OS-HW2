...
/*input:two ints number and a base to execute the modulo function on it,
it operates in a way that deal with negative input.
*/
int moudlo(int num, int base);

/*input: the argc
checks if the number of the command arguments is valid
if not exit with the relevant error.
*/
